/**
 * Minimal Example: Google Gemini Function Calling
 * Run with: npx tsx examples/gemini-function-calling-minimal.ts
 */
...
async function main() {
  // Gemini function call with user query: "Find movers in Brooklyn"
  console.log('🤖 Gemini Function Calling - Minimal Example\n');

  // 1. Build opportunity from function arguments
